var App = function() {
    ...
    return {
        ...
        showModal: function(){
            ...
            $.ajax({
                url: 'https://api.noencontrado.org/v1/last',
                type: 'GET',
                // data: {method: 'quitarPresentacion'},
                dataType: 'json',
                beforeSend: function () {
                  App.blockUI();
                },
                ...
                success: function (response) {
                  ...
                  $("#Datos").children().first().html("Nombre: "+personas[0].nombre);
                  $("#Datos").children().eq(1).html("Edad: "+personas[0].edad);
                   $("#Datos img").attr({src:'https://static.noencontrado.org/img/'+personas[0].id+'.jpg'});
                }
            });
            $("#myModal").modal();
        }
